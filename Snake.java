...
public class Snake
{
    ...
    public void dibujar(Canvas lienzo)
    {
        ...
        lienzo.fillCircle(ultimoSegmento.getPosicionFinalX()-(TAMANO_CABEZA/2),
            ultimoSegmento.getPosicionFinalY(), TAMANO_CABEZA);
    }
    ...
    /**
     * borra el último segmento de la serpeinte y crea uno nuevo al principio
     */
    public boolean mover(Canvas lienzo) 
    {
        boolean move = addSegment();
        segmentos.remove(0);
        return move;
    }
    
    public int getXPosPrimerSegmento()
    {
        Segment primerSegmento = segmentos.get(0);
        return primerSegmento.getPosicionInicialX();
    }
    
    public int getYPosPrimerSegmento()
    {
        Segment primerSegmento = segmentos.get(0);
        return primerSegmento.getPosicionInicialY();
    }
}